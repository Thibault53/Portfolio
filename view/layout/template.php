...
<head>
  ...
  <title>Bienvenue sur le Portfolio de Thibault Yvard</title>
  ...
  <script src="https://kit.fontawesome.com/a5cc9de477.js" crossorigin="anonymous"></script>
        ...
        <div class="row">
          <div class="col-sm-6 col-xs-12">
            <div class="copyright_text m-t-2 text-xs-center">
              <p class="wow zoomIn" data-wow-duration="1s">Made
                with <i class="fa fa-heart"></i> by <a target="_black" href="http://bootstrapthemes.co">
                  Thibault Yvard</a> 2016. All Rights
                Reserved</p>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="socail_coppyright text-sm-right m-t-2
                                text-xs-center wow zoomIn">
